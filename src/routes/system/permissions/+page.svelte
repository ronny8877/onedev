		...
		<div class="card bg-base-200 rounded-xl">
			<div class="card-body py-4">
				...
				<ul class="mt-2 space-y-1 text-sm text-base-content/70">
					<li>• Uses the Permissions API to check status</li>
					<li>• No prompts unless you click "Request"</li>
					<li>• Denied permissions can be reset in browser settings</li>
					<li>• Some permissions may not be queryable in all browsers</li>
				</ul>
			</div>
		</div>
	</div>
