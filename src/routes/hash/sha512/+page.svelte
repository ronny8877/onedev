<script lang="ts">
	...
	const content = hashToolsContent['sha512'];
	...
	const ALGORITHM = 'SHA-512' as const;
	...
	<div class="flex flex-col gap-6">
				...
				<div class="card-body p-4">
					<div class="flex items-center justify-between gap-2 mb-3">
						<div class="flex items-center gap-2">
							<span class="font-semibold">SHA-512 Hash</span>
							<span class="badge badge-primary badge-sm">512 bits</span>
		...
		{#if isProcessing && inputMode === 'text'}
			<div class="flex items-center justify-center gap-2 py-4">
				...
				<span class="text-sm text-base-content/70">Generating SHA-512...</span>
			</div>
		{/if}
