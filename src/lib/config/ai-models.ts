...
export const CHAT_MODELS: ChatModel[] = [
	...
	},
	{
		...
		reasoning: false,
		apiAvailability: true,
		notes: 'Listed as gpt-5.6-luna. 1.05M context. Long-context band (prompts over 272K) $0.40 / $1.80 per 1M. Same $0.20 input floor as Grok 4.1 Fast with higher output price.'
	},
	// GPT-5.5 family — previous frontier, released April 2026
	{
		name: 'gpt-5.5',
		displayName: 'GPT-5.5',
		provider: 'openai',
		...
		reasoning: true,
		apiAvailability: true,
		notes: 'Released Apr 24, 2026. Same $5 / $30 card as GPT-5.6 Sol. Cached input $0.50. Long-context band (prompts over 272K) $10 / $45. Prefer Sol or Terra for new work unless you need this snapshot.'
	},
	{
		name: 'gpt-5.5-pro',
		...
		reasoning: true,
		apiAvailability: true,
		notes: 'Premium tier of GPT-5.5. For workloads where accuracy outweighs cost. Cached input listed at 10% of input. Batch/Flex at 50% off.'
	},
	{
		name: 'gpt-5.5-mini',
		...
		reasoning: true,
		apiAvailability: true,
		notes: 'Released May 2026. Prefer GPT-5.6 Terra ($2 / $12) or Luna ($0.20 / $1.20) for new cheap-volume work.'
	},
	// GPT-5.4 family — still listed, released March 2026
	{
		name: 'gpt-5.4',
		displayName: 'GPT-5.4',
		provider: 'openai',
		...
		multimodal: true,
		releaseDate: '2026-03',
		strengths: 'Coding, computer use, general reasoning, agentic tasks',
		speedCategory: 'balanced',
		reasoning: false,
		apiAvailability: true,
		notes: 'Previous flagship. Prefer GPT-5.6 Terra at a similar $2 input band with a lower $12 output rate. 1.05M context.'
	},
	{
		name: 'gpt-5.4-mini',
		...
		reasoning: false,
		apiAvailability: true,
		notes: 'Still listed. Prefer GPT-5.6 Luna ($0.20 / $1.20) when you want the current cheap GPT-5.6 tier.'
	},
	{
		name: 'gpt-5.4-nano',
		...
		reasoning: false,
		apiAvailability: true,
		notes: 'Cheapest GPT-5.4 variant. Prefer Luna when you want the current GPT-5.6 cheap tier at the same $0.20 input.'
	},
	...
	},
	{
		...
		multimodal: true,
		releaseDate: '2026-06',
		strengths: 'Same $10 / $50 card as Fable 5; limited first-party availability',
		speedCategory: 'slow',
		reasoning: true,
		apiAvailability: true,
		tokenizerFactor: 1.30,
		notes: 'On the official price table at $10 / $50. Limited availability (Glasswing). Prefer Fable 5 if you do not have access.'
	},
	{
		name: 'claude-opus-5',
	...
	},
	{
		...
		multimodal: true,
		releaseDate: '2026-08',
		strengths: 'Current Gemini Flash for coding, search, and grounding',
		speedCategory: 'fast',
		reasoning: true,
		apiAvailability: true,
		notes: 'Shipped Aug 13, 2026. Introductory $0.75 / $3.75 through 31 Dec 2026, then $1.50 / $7.50 from 1 Jan 2027. Cache $0.075 now / $0.15 in January. Thinking tokens billed as output.'
	},
	{
		...
		multimodal: true,
		releaseDate: '2026-07',
		strengths: 'Gemini 3.6 Flash: same intro rate as 3.7 Flash after the August 2026 cut',
		speedCategory: 'fast',
		reasoning: true,
		apiAvailability: true,
		notes: 'Listed as gemini-3.6-flash. Introductory $0.75 / $3.75 through 31 Dec 2026 (matches 3.7 Flash), then $1.50 / $7.50 from 1 Jan 2027. Prefer 3.7 Flash for new work.'
	},
	{
