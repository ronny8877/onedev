...
// Stored preference is light | dark. Daisy dark is forest. This is the only mapping.
// The FOUC boot script in src/app.html inlines the same ternary because it cannot import this module.
